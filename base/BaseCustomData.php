...
class BaseCustomData
{
     ...
     * @param  String $orderBy - A string value for order
     *
     * @return Table result
     */
    public function get_by(array $conditionValue, $condition = '=', $orderBy = NULL, $limit = null, $colums = '*', 
                            $type = 'OBJECT')
    {
        global $wpdb;
        ...
        $sql = 'SELECT '.$colums.' FROM `'.$this->tableName.'` WHERE ';
